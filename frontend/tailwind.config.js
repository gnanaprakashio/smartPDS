    ...
    extend: {
      colors: {
        ...
        dark: {
          ...
          bgSecondary: '#1e293b', // Slate 800 - Secondary background
      ...
      boxShadow: {
        ...
        'card-hover': '0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.05), 0 10px 15px -3px rgba(0, 0, 0, 0.05)',
